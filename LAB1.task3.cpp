...
void viewStudents(Student students[], int numStudents) {
    ...
    for (int i = 0; i < numStudents; ++i) {
        ...
        if (students[i].getGrade().mark != 0) {
            cout << "Mark: " << students[i].getGrade().mark << endl;
            cout << "Grade: " << students[i].getGrade().the_grade << endl;
        }
        cout << "\n";
    }
}
